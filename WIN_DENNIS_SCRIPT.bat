...
echo 4) Probar Conexion [ping google]
echo 5) Borrar Archivos Temp
echo 6) MAC de los Adaptadores de la PC
echo 7) Compartir Carpeta
echo ------------------------------ 
echo S^|s) Salir
echo ------------------------------ 
echo. 
...
cls
echo. ---------------------------------------------
echo. Has elegido la opcion ADAPTADORES DE LA PC 
echo. ---------------------------------------------
echo.
getmac /v
echo.
...
cls
echo. ---------------------------------------------
echo. Has elegido la opcion COMPARTIR CARPETA 
echo. ---------------------------------------------
echo.
chdir
pause
